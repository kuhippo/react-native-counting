...
- (void)setTextValue:(CGFloat)value
{
    ...
    else
    {
        ...
        {
            NSString *format = @"%.2f";
            NSString *positiveFormat = @"###，##0.00";
            NSString *str = [NSString stringWithFormat:format,value];
...
- (void)showNormalMoney:(CGFloat)money{
    NSString *format = @"%.2f";
    NSString *positiveFormat = @"###，##0.00";
    NSString *str = [NSString stringWithFormat:format,money];
    NSNumberFormatter *formatter = [NSNumberFormatter new];
    formatter.numberStyle = NSNumberFormatterDecimalStyle;
    [formatter setPositiveFormat:positiveFormat];
//    self.text = [NSString stringWithFormat:@"%@",[formatter stringFromNumber:[NSNumber numberWithFloat:[str floatValue]]]];
    self.text = [[NSString alloc] initWithFormat:@"%.2f",money];
